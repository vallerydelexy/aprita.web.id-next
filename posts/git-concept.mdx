...
title: Git concept
slug: git-concept
description: 'learn git concept, not commands'
thumbnailUrl: /images/post/learn-git-concept.jpg
thumbnailAlt: concept of git technology
...
[![git components](/images/post/components.png)](/images/post/components.png)
...
<a id="getting-a-remote-repository"></a>
...
[![Cloning the remote repo](/images/post/clone.png)](/images/post/clone.png)

<a id="adding-new-things"></a>
...
[![Adding changes to the staging area](/images/post/add.png)](/images/post/add.png)
...
[![Committing to the local repo](/images/post/commit.png)](/images/post/commit.png)
...
[![Pushing to the local repo](/images/post/push.png)](/images/post/push.png)
...
[![State of all components after pushing changes](/images/post/after_push.png)](/images/post/after_push.png)

<a id="making-changes"></a>
...
[![States of a change an related diff commands](/images/post/diffs.png)](/images/post/diffs.png)
...
[![State after adding branch](/images/post/add_branch.png)](/images/post/add_branch.png)
...
[![State after after switching branch](/images/post/checkout_branch.png)](/images/post/checkout_branch.png)
...
[![Remote and local branches`](/images/post/branches.png)](/images/post/branches.png)
...
[![Before fast forward merge](/images/post/before_ff_merge.png)](/images/post/before_ff_merge.png)

The second diagram shows what has changed with our `merge`.

[![After fast forward merge](/images/post/ff_merge.png)](/images/post/ff_merge.png)

#<a id="merging-divergent-branches"></a>
...
[![Divergent commits](/images/post/branches_diverge.png)](/images/post/branches_diverge.png)
...
[![Merging branches](/images/post/merge.png)](/images/post/merge.png)
...
[![History before a rebase](/images/post/before_rebase.png)](/images/post/before_rebase.png)
...
[![History after rebase](/images/post/rebase.png)](/images/post/rebase.png)
...
<a id="updating-the-dev-environment-with-remote-changes"></a>
...
[![many dev environments](/images/post/many_dev_environments.png)](/images/post/many_dev_environments.png)
...
[![github edit](/images/post/github.png)](/images/post/github.png)
...
[![Fetching changes](/images/post/fetch.png)](/images/post/fetch.png)
...
[![Pulling in changes](/images/post/pull.png)](/images/post/pull.png)
...
[![Branches before cherry-picking](/images/post/cherry_branches.png)](/images/post/cherry_branches.png)
...
[![Cherry-picking a single commit](/images/post/cherry_pick.png)](/images/post/cherry_pick.png)
...
#<a id="amending-the-last-commit"></a>
...
#<a id="public-history-why-you-shouldnt-rewrite-it-and-how-to-still-do-it-safely"></a>
...
[![What happens in a push --force-with-lease](/images/post/force_push.png)](/images/post/force_push.png)
