...
export default function Header({ tagline }) {
  ...
  return (
    <div className="relative pt-4 md:pt-6 z-50">
      <Popover>
        {({ open }) => (
          <>
                ...
                <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    ...
                    <div className="flex gap-4 md:hidden">
                      <div className="inline-flex rounded-md shadow px-4 py-2 border border-transparent text-base font-medium rounded-md text-indigo-600 backdrop-filter backdrop-blur-sm bg-white hover:bg-gray-50">
                        {mode === "dark" && (
            ...
            >
              ...
              >
                <div className="rounded-lg shadow-md backdrop-filter backdrop-blur-sm bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
